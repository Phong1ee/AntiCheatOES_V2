...
VIOLATION_EVENT_TYPES = {
    ...
    "SPEECH_ACTIVITY_DETECTED", "MULTIPLE_VOICES_DETECTED",
}
...
EVENT_SOURCE_BY_TYPE = {
    **{event_type: "browser" for event_type in VIOLATION_EVENT_TYPES},
    "CAMERA_PERMISSION_DENIED": "camera",
    "CAMERA_TRACK_MUTED": "camera",
    "CAMERA_TRACK_ENDED": "camera",
    "MIC_PERMISSION_DENIED": "microphone",
    "MIC_TRACK_MUTED": "microphone",
    "MIC_TRACK_ENDED": "microphone",
    ...
    "MULTIPLE_VOICES_DETECTED": "microphone",
}
