...
export function QuestionPoolModal({ examId, existingQuestionIds, subjectId: examSubjectId, initialPoolConfig, poolDraft, onPoolDraftChange, allowManual = true, onClose, onImported }: QuestionPoolModalProps) {
