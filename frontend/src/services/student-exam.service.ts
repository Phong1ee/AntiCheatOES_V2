...
export const studentExamService = {
  ...
  async recordAntiCheatEvent(examId: string | number, attemptId: number, eventType: string, source: "browser" | "camera" | "microphone", details?: string, metadata?: Record<string, string | number>): Promise<AntiCheatEventResult> {
